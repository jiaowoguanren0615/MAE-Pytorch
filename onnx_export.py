...
parser.add_argument('--checkpoint', default='./output/mae_vit_base_patch16_best_checkpoint.pth', type=str, metavar='PATH',
...
def main():
    ...
    if args.output == None:
        args.output = f'./{args.mae_model}.onnx'

    print("==> Creating PyTorch {} model".format(args.mae_model))
    ...
    model.load_state_dict(torch.load(args.checkpoint, weights_only=True)['model'])
    model.eval()
